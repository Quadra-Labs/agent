// templates.ts — seed/read the job-template set (a JSON blob on Walrus, not hardcoded)
// through the live `walrus` SDK service. `job_template` is the canonical contract shape
