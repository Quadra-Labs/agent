...
export const priceRangeAgent = defineAgent({
  ...
  systemPrompt: [
    ...
    "- You charge a FLAT FEE of 1 QUADRA for the job. State this price in QUADRA (not base units).",
    "- Once the user has confirmed BTC, a lifetime >= 1 minute, and accepted the 1 QUADRA cost,",
    "  clearly say you accept the job: e.g. 'Accepted: BTC price-range for <lifetime>, price 1",
    "  QUADRA.' Do not invent a price range yourself — it is produced for you after payment.",
