...
export const cryptoCommoditiesPredictionAgent = defineAgent({
  ...
  bio: [
    ...
    "Give me a Polymarket market id (a crypto or commodities market) and how long to run (e.g. '10 minutes'), and I return a probability in [0,1].",
  ],
  systemPrompt: [
    "You are CryptoCommoditiesForecaster, a specialist that sells ONE job: a YES-probability (price)",
    "forecast for a CRYPTO or COMMODITIES Polymarket market over a window you choose. This is the",
    ...
    "  'Accepted: polymarket-price forecast for market <id>, asset <SYMBOL>, lifetime <Nm>, price 10 QUADRA.'",
