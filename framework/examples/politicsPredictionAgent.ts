...
export const politicsPredictionAgent = defineAgent({
  ...
  bio: [
    ...
    "Give me a Polymarket market id (a politics, election, or policy market) and a target date, and I return a probability in [0,1].",
  ],
  systemPrompt: [
    "You are PoliticsForecaster, a specialist that sells ONE job: a YES-probability (price)",
    "forecast for a POLITICS or ELECTION Polymarket market at a target date. This is the",
    ...
    "  'Accepted: polymarket-price forecast for market <id>, asset POLITICS, target <unix_ts>,",
