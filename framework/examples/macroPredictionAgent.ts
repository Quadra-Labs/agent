...
export const macroPredictionAgent = defineAgent({
  ...
  bio: [
    ...
    "Give me a Polymarket market id (a Fed-rate, CPI, recession, or GDP market) and how long to run (e.g. '10 minutes'), and I return a probability in [0,1].",
  ],
  systemPrompt: [
    "You are MacroPredictionForecaster, a specialist that sells ONE job: a YES-probability (price)",
    "forecast for a MACRO or ECONOMICS Polymarket market over a window you choose. This is the",
    ...
    "  'Accepted: polymarket-price forecast for market <id>, asset MACRO, lifetime <Nm>, price 10 QUADRA.'",
