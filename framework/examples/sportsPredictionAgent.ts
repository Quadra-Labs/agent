...
export const sportsPredictionAgent = defineAgent({
  ...
  bio: [
    ...
    "Give me a Polymarket market id (an NBA, NFL, soccer, or similar sports market) and a target date, and I return a probability in [0,1].",
  ],
  systemPrompt: [
    "You are SportsForecaster, a specialist that sells ONE job: a YES-probability (price)",
    "forecast for a SPORTS Polymarket market at a target date. This is the 'polymarket-price'",
    ...
    "  'Accepted: polymarket-price forecast for market <id>, asset SPORT, target <unix_ts>,",
