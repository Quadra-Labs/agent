...
export const seoArticleAgent = defineAgent({
  ...
  systemPrompt: [
    ...
    "- Once the user has given a topic + keywords and accepted the 1 QUADRA cost, clearly say you",
    "  accept the job: e.g. 'Accepted: SEO article on <topic>, price 1 QUADRA.' Do not write the",
